...
def eval_market1501(distmat, q_pids, g_pids, q_camids, g_camids, max_rank):
    ...
    #输出matches
    matchpath = osp.join('/mnt/data/code/reidlog/dist', 'matches.txt')
    np.savetxt(matchpath, matches)
    np.savetxt(osp.join('/mnt/data/code/reidlog/dist', 'matches.csv'), matches, delimiter=',')
