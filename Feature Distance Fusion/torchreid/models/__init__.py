...
__model_factory = {
    ...
    'uniformer_small': uniformer_small,
    'uniformer_small_plus': uniformer_small_plus,
    'uniformer_small_plus_dim64': uniformer_small_plus_dim64,
    'uniformer_base': uniformer_base,
    'uniformer_base_ls': uniformer_base_ls,
    # lightweight models
