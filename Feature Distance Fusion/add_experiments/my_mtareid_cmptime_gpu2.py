...
# distmat
print('cmp distmatori * 2 + distmat_hr4 + distmat_hr3 + distmat_hr2 + distmat_hr22')
# cwd.computeCMC(distmatori * 2 + distmat_hr4  + distmat_hr3 + distmat_hr2, q_pids, g_pids, q_camids, g_camids,)
cwd.computeCMC(distmatori * 2 + distmat_hr4 + distmat_hr3 + distmat_hr2 + distmat_hr22 , q_pids, g_pids, q_camids, g_camids,)
