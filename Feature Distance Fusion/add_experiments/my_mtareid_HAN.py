...
save_dir = '/mnt/data/code/reidlog/MTA_reid_HAN/test'
log_name = 'test.log'
...
#     model_load_weights='/mnt/data/code/reidlog/MTA_reid_HAN/x3/model/model-best.pth.tar',
#     dataset='MTA_reid_new',
# )
#
# distmat_hr2, _, _, _, _, _, _, _, _, qflr2, gflr2 = cwd.main(
#     root='/mnt/data/datasets/MTA_reid/MTA_reid_HAN/x2',
#     model_load_weights='/mnt/data/code/reidlog/MTA_reid_HAN/x2/model/model-best.pth.tar',
#     dataset='MTA_reid_new',
# )

# distmat_hr22, _, _, _, _, _, _, _, _, qflr2, gflr2 = cwd.main(
#     root='/mnt/data/datasets/MTA_reid/MTA_reid_HAN/x2',
#     model_load_weights='/mnt/data/code/reidlog/MTA_reid_HAN/x2/model/model.pth.tar-50',
#     dataset='MTA_reid_new',
# )

print('dist ori+lr22')
computeCMC(distmatori + distmat_hr22, q_pids, g_pids, q_camids, g_camids)
print('\n\n')
