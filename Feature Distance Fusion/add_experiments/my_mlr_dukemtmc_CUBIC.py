...
save_dir = '/mnt/data/code/reidlog/mlr_dukemtmc_CUBIC/test'
log_name = 'test.log'
...
distmatori, q_pids, g_pids, q_camids, g_camids, qsize1_, qsize2_, qsize_, gsize_, qf, gf = cwd.main(
    ...
    model_load_weights='/mnt/data/code/reidlog/ORI/mlr_dukemtmc_ori/2023-08-15-10-50-28model/model.pth.tar-250',
    dataset='MLR_DukeMTMC'
)

distmat_hr4, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC_CUBIC/x4',
    model_load_weights='/mnt/data/code/reidlog/mlr_DukeMTMC_CUBIC/x4/model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
)

distmat_hr3, _, _, _, _, _, _, _, _, qflr1, gflr1 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC_CUBIC/x3',
    model_load_weights='/mnt/data/code/reidlog/mlr_DukeMTMC_CUBIC/x3/model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
)

distmat_hr2, _, _, _, _, _, _, _, _, qflr2, gflr2 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC_CUBIC/x2',
    model_load_weights='/mnt/data/code/reidlog/mlr_DukeMTMC_CUBIC/x2/model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
)
