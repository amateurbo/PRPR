...
save_dir = '/mnt/data/code/reidlog/mlr_cuhk03_CUBIC/test'
log_name = 'test.log'
...
distmat_hr4, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    ...
    model_load_weights='/mnt/data/code/reidlog/mlr_cuhk03_CUBIC/x4/model/model-best.pth.tar',
    dataset='MLR_CUHK03',
)

distmat_hr3, _, _, _, _, _, _, _, _, qflr1, gflr1 = cwd.main(
    root='/mnt/data/datasets/CUHK03/mlr_cuhk03_CUBIC/x3',
    model_load_weights='/mnt/data/code/reidlog/mlr_cuhk03_CUBIC/x3/model/model-best.pth.tar',
    dataset='MLR_CUHK03',
)

distmat_hr2, _, _, _, _, _, _, _, _, qflr2, gflr2 = cwd.main(
    root='/mnt/data/datasets/CUHK03/mlr_cuhk03_CUBIC/x2',
    model_load_weights='/mnt/data/code/reidlog/mlr_cuhk03_CUBIC/x2/model/model-best.pth.tar',
    dataset='MLR_CUHK03',
)
