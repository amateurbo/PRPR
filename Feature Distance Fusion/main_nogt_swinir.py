...
def main():
    ...
    parser.add_argument('--training_patch_size', type=int, default=64, help='patch size used in training SwinIR. '
                                       ...
                                       'Images are NOT tested patch by patch.')
    parser.add_argument('--large_model', action='store_true', help='use large model, only provided for real image sr')
    parser.add_argument('--model_path', type=str, default='model_zoo/rcam_duke_s64w8_x2/23100_E.pth')
    parser.add_argument('--folder_lq', type=str, default='/mnt/data/mlr_datasets/CAVIAR/bounding_box_train', help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default='/mnt/data/mlr_datasets/CAVIAR/bounding_box_train', help='input ground-truth test image folder')
    args = parser.parse_args()
