...
class MLR_DukeMTMC(ImageDataset):
    ...
    def __init__(self, root='', **kwargs):
        ...
        # self.train_dir = osp.join(self.dataset_dir, 'bounding_box_train_merge_blur_augmix')
...
def main():
    ...
    parser.add_argument(
        '--config-file', type=str, default='../configs/MLR_DukeMTMC.yaml', help='path to config file'
    )
    parser.add_argument(
        '-s',
        '--sources',
    ...
    # save_dir = '/mnt/data/code/reidlog_2/mlr_duke_body_blur'
    ...
    # root = cfg.data.root
    root = '/mnt/data/MLR_Datasets/MLR_DukeMTMC'
