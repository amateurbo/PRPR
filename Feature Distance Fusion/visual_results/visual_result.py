...
for s in data:
    ...
    writer.add_scalars('PNSR/iter',
                       {'train_PSNR': s[1], 'train_PSNR_Y': s[3], 'query_PSNR': s[5], 'query_PSNR_Y': s[7]}, s[0])
    writer.add_scalars('SSIM/iter',
                       {'train_SSIM_RGB': s[2], 'train_SSIM_Y': s[4], 'query_SSIM_RGB': s[6], 'query_SSIM_Y': s[8]}, s[0])
    writer.add_scalar('mAP/iter', s[9], s[0])
    writer.add_scalar('Rank1/iter', s[10], s[0])
    writer.add_scalar('Rank5/iter', s[11], s[0])
    writer.add_scalar('Rank10/iter', s[12], s[0])
    writer.add_scalar('Rank20/iter', s[13], s[0])
    writer.add_scalars('ReID/iter',
                       {'mAP': s[9], 'Rank1': s[10], 'Rank5': s[11], 'Rank10': s[12], 'Rank20': s[13]}, s[0])
