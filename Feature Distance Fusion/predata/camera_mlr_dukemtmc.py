...
#设置源数据路径及存储路径
testpath = '/mnt/data/reiddata/DukeMTMC-reID/bounding_box_test'
trainpath = '/mnt/data/reiddata/DukeMTMC-reID/bounding_box_train'
querypath = '/mnt/data/reiddata/DukeMTMC-reID/query'
