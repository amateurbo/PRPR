...
#设置源数据路径及存储路径
testpath = '/mnt/data/mlr_datasets/market1501/mlr_market1501/bounding_box_test'
trainpath = '/mnt/data/mlr_datasets/market1501/mlr_market1501/bounding_box_train'
querypath = '/mnt/data/mlr_datasets/market1501/mlr_market1501/query'


querysavepath = '/mnt/data/mlr_datasets/market1501/c1/mlrc1_market1501/query'
testsavepath = '/mnt/data/mlr_datasets/market1501/c1/mlrc1_market1501/bounding_box_test'
trainsavepath = '/mnt/data/mlr_datasets/market1501/c1/mlrc1_market1501/bounding_box_train'
...
for i in range(len(imglist)):
    ...
    #找出相机编号为C1的图片放入train
    if (int(id) > 0) & (camera == 'c1'):
        shutil.copy(imgpath, trainsavepath)