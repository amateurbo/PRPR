...
save_dir = '/mnt/data/code/reidlog/mlr_market1501_CUBIC/test_last'
log_name = 'test.log'
...
distmatori, q_pids, g_pids, q_camids, g_camids, qsize1_, qsize2_, qsize_, gsize_, qf, gf = cwd.main(
    ...
    model_load_weights='/mnt/data/code/reidlog/ORI/mlr_market1501_ori/model/model.pth.tar-250',
    dataset='mlr_market1501',
    # rerank=True
)

distmat_hr4, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_CUBIC/x4',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_CUBIC/x4/model/model.pth.tar-250',
    dataset='mlr_market1501',
)

distmat_hr3, _, _, _, _, _, _, _, _, qflr1, gflr1 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_CUBIC/x3',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_CUBIC/x3/model/model.pth.tar-250',
    dataset='mlr_market1501',
)

distmat_hr2, _, _, _, _, _, _, _, _, qflr2, gflr2 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_CUBIC/x2',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_CUBIC/x2/model/model.pth.tar-250',
    dataset='mlr_market1501',
)
