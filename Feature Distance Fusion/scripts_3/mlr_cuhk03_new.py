...
class MLR_CUHK03(ImageDataset):
    # dataset_dir = 'MLR_CUHK03'
    ...
    def __init__(self, root='', **kwargs):
        ...
        super(MLR_CUHK03, self).__init__(train, query, gallery, **kwargs)
    ...
    def process_dir(self, dir_path, relabel=False):
        ...
        for imgname in imgnames:
            campid = imgname.split('_')[0]
            pid = int(imgname.split('_')[1]) - 1
            if campid == '2':
                pid += 843
            elif campid == '3':
                pid += 1283
...
import torchreid
torchreid.data.register_image_dataset('MLR_CUHK03', MLR_CUHK03)
...
def main():
    ...
    parser.add_argument(
        '--config-file', type=str, default='../configs/MLR_CUHK03.yaml', help='path to config file'
    )
    parser.add_argument(
        '-s',
        '--sources',
