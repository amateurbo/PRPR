...
save_dir = '/mnt/data/code/reidlog/mlr_dukemtmc_new_3/test'
log_name = 'test.log'
...
distmathr, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down_3/hr',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new_3/hr/2022-09-12-10-58-10model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)

distmatlr1, _, _, _, _, _, _, _, _, qflr1, gflr1 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down_3/x2',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new_3/x2/2022-09-12-13-49-45model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)

distmatlr2, _, _, _, _, _, _, _, _, qflr2, gflr2 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down_3/x3',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new_3/x3/2022-09-12-16-40-53model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)

distmatlr3, _, _, _, _, _, _, _, _, qflr3, gflr3 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down_3/x4',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new_3/x4/2022-09-12-19-30-54model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)
