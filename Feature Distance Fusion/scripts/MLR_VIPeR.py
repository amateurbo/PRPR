...
class MLR_VIPeR(ImageDataset):
    dataset_dir = 'MLR_VIPeR'
    ...
    def __init__(self, root='', **kwargs):
        ...
        super(MLR_VIPeR, self).__init__(train, query, gallery, **kwargs)
...
import torchreid
torchreid.data.register_image_dataset('MLR_VIPeR', MLR_VIPeR)
...
def main():
    ...
    parser.add_argument(
        '--config-file', type=str, default='../configs/MLR_VIPeR.yaml', help='path to config file'
    )
    parser.add_argument(
        '-s',
        '--sources',
