...
class mlr_market1501(ImageDataset):
    # dataset_dir = 'mlr_market1501'
    ...
    def __init__(self, root='', **kwargs):
        ...
        super(mlr_market1501, self).__init__(train, query, gallery, **kwargs)
    ...
    def process_dir(self, dir_path, relabel=False):
        ...
        flag = False
        a = img_paths[0].find('_c')
        if img_paths[0].find('_c') != -1:
            flag = True
        ...
        for imgname in imgnames:
            ...
            pid = int(imgname.split('_')[0]) - 1
            if flag:
                camid = int(imgname.split('_')[1][1:2])
            else:
                camid = int(imgname.split('_')[1])
...
import torchreid
torchreid.data.register_image_dataset('mlr_market1501', mlr_market1501)
...
def main():
    ...
    parser.add_argument(
        '--config-file', type=str, default='../configs/mlr_market1501.yaml', help='path to config file'
    )
    parser.add_argument(
        '-s',
        '--sources',
    ...
    # root = '/mnt/data/code/SwinIR-main/results/swinir_classical_sr_x5_x5_2500_E'
    datamanager = torchreid.data.ImageDataManager(
        root=root,
        # root='/mnt/data/finish/market1501/mlr_market1501_hr_dsx2/x4_hrdownsaple',
