...
save_dir = '/mnt/data/code/reidlog/mlr_market1501_new_2/test'
log_name = 'test.log'
...
distmathr, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down_2/hr',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new_2/hr/2022-05-19-20-59-01model/model-best.pth.tar',
    dataset='mlr_market1501',
    # rerank=True
)

distmatx2, _, _, _, _, _, _, _, _, qfx2, gfx2 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down_2/x2',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new_2/x2/2022-05-19-23-14-46model/model-best.pth.tar',
    dataset='mlr_market1501',
    # rerank=True
)

distmatx3, _, _, _, _, _, _, _, _, qfx3, gfx3 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down_2/x3',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new_2/x3/2022-05-20-01-30-05model/model-best.pth.tar',
    dataset='mlr_market1501',
    # rerank=True
)

distmatx4, _, _, _, _, _, _, _, _, qfx4, gfx4 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down_2/x4',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new_2/x4/2022-05-20-03-45-44model/model-best.pth.tar',
    dataset='mlr_market1501',
    # rerank=True
)
