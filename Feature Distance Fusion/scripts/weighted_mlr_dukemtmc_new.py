...
save_dir = '/mnt/data/code/reidlog/mlr_dukemtmc_new/test'
log_name = 'test.log'
...
distmathr, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down/hr',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new/hr/2022-05-02-11-11-29model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)

distmatx2, _, _, _, _, _, _, _, _, qfx2, gfx2 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down/x2',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new/x2/2022-05-02-14-01-59model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)

distmatx3, _, _, _, _, _, _, _, _, qfx3, gfx3 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down/x3',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new/x3/2022-05-02-16-50-33model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)

distmatx4, _, _, _, _, _, _, _, _, qfx4, gfx4 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down/x4',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new/x4/2022-05-02-19-38-35model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)

distmatx8, _, _, _, _, _, _, _, _, qfx8, gfx8 = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down/x8',
