...
save_dir = '/mnt/data/code/reidlog/MLR_DukeMTMC/test'
log_name = 'test.log'
...
distmatx2, _, _, _, _, _, _, _, _, qfx2, gfx2 = cwd.main(
    root='/mnt/data/code/SwinIR-main/results/swinir_classical_sr_MLR_DukeMTMC_x2_4400_E',
    model_load_weights='/mnt/data/code/reidlog/MLR_DukeMTMC/x2/osnet_x1_0_x2_4400_E_x2_MLR_DukeMTMC_softmax_cosinelr/2022-03-12-23-38-37model/model.pth.tar-216',
    dataset='MLR_DukeMTMC'
)

distmatx3, _, _, _, _, _, _, _, _, qfx3, gfx3 = cwd.main(
    root='/mnt/data/code/SwinIR-main/results/swinir_classical_sr_MLR_DukeMTMC_x3_4000_E',
    model_load_weights='/mnt/data/code/reidlog/MLR_DukeMTMC/x3/osnet_x1_0_x3_4000_E_x3_MLR_DukeMTMC_softmax_cosinelr/2022-03-13-02-27-00model/model.pth.tar-240',
    dataset='MLR_DukeMTMC'
)

distmatx4, _, _, _, _, _, _, _, _, qfx4, gfx4 = cwd.main(
    root='/mnt/data/code/SwinIR-main/results/swinir_classical_sr_MLR_DukeMTMC_x4_4600_E',
    model_load_weights='/mnt/data/code/reidlog/MLR_DukeMTMC/x4/osnet_x1_0_x4_4600_E_x4_MLR_DukeMTMC_softmax_cosinelr/2022-03-13-05-15-46model/model.pth.tar-240',
    dataset='MLR_DukeMTMC'
)

distmatx8, _, _, _, _, _, _, _, _, qfx8, gfx8 = cwd.main(
    root='/mnt/data/code/SwinIR-main/results/swinir_classical_sr_MLR_DukeMTMC_x8_4600_E',
    model_load_weights='/mnt/data/code/reidlog/MLR_DukeMTMC/x8/osnet_x1_0_x8_4600_E_x8_MLR_DukeMTMC_softmax_cosinelr/2022-03-13-08-04-15model/model.pth.tar-235',
    dataset='MLR_DukeMTMC'
)
