...
save_dir = '/mnt/data/code/reidlog/mlr_dukemtmc_new_2/test'
log_name = 'test.log'
...
distmathr, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    root='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down_2/hr',
    model_load_weights='/mnt/data/code/reidlog/mlr_dukemtmc_new_2/hr/2022-05-18-21-10-23model/model-best.pth.tar',
    dataset='MLR_DukeMTMC',
    # rerank=True
)
