...
save_dir = '/mnt/data/code/reidlog/mlr_market1501_HAN/test'
log_name = 'test.log'
...
distmathr, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_HAN/hr',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_HAN/hr/2022-09-05-22-44-04model/model-best.pth.tar',
    dataset='mlr_market1501',
    # rerank=True
)

distmatlr1, _, _, _, _, _, _, _, _, qflr1, gflr1 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_HAN/lr1',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_HAN/lr1/2022-09-06-00-59-48model/model-best.pth.tar',
    dataset='mlr_market1501',
    # rerank=True
)

distmatlr2, _, _, _, _, _, _, _, _, qflr2, gflr2 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_HAN/lr2',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_HAN/lr2/2022-09-06-03-15-00model/model-best.pth.tar',
    dataset='mlr_market1501',
    # rerank=True
)

distmatlr3, _, _, _, _, _, _, _, _, qflr3, gflr3 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_HAN/lr3',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_HAN/lr3/2022-09-06-05-30-51model/model-best.pth.tar',
    dataset='mlr_market1501',
    # rerank=True
)
