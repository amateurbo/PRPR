...
save_dir = '/mnt/data/code/reidlog/mlr_market1501_new/test'
log_name = 'test.log'
...
distmatori, q_pids, g_pids, q_camids, g_camids, qsize1_, qsize2_, qsize_, gsize_, qf, gf = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/market1501/mlr_market1501',
...
distmathr, _, _, _, _, _, _, _, _, qfhr, gfhr = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down/hr',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new/hr/2022-05-02-21-46-32model/model.pth.tar-218',
    dataset='mlr_market1501',
    # rerank=True
)

distmatx2, _, _, _, _, _, _, _, _, qfx2, gfx2 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down/x2',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new/x2/2022-05-03-01-48-42model/model.pth.tar-213',
    dataset='mlr_market1501',
    # rerank=True
)

distmatx3, _, _, _, _, _, _, _, _, qfx3, gfx3 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down/x3',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new/x3/2022-05-03-05-07-27model/model.pth.tar-225',
    dataset='mlr_market1501',
    # rerank=True
)

distmatx4, _, _, _, _, _, _, _, _, qfx4, gfx4 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down/x4',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new/x4/2022-05-03-07-22-47model/model.pth.tar-213',
    dataset='mlr_market1501',
    # rerank=True
)

distmatx8, _, _, _, _, _, _, _, _, qfx8, gfx8 = cwd.main(
    root='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down/x8',
    model_load_weights='/mnt/data/code/reidlog/mlr_market1501_new/x8/2022-05-03-09-38-36model/model.pth.tar-215',
    dataset='mlr_market1501'
    # rerank=True
)
# distmat
