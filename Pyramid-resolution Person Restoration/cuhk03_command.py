...
models_path = '/home/gpu/code/SwinIR-main/model_zoo/MLR_CUHK03' #model path
...
for scale in model_scales:
    ...
    sr_task = 'python main_nogt_swinir.py --task classical_sr --scale ' + numscale + ' --training_patch_size 64 --window_size 8 --model_path '
    ...
    reid_log = ' data.save_dir /mnt/data/code/reidlog/MLR_CUHK03/'+ scale +'/osnet_x1_0_test_'+ scale +'_CUHK03_softmax_cosinelr'

    #超分
    os.system(sr_query)
    os.system('cp -r /mnt/data/datasets/CUHK03/bounding_box_train/  results/swinir_classical_sr_'+ scale +'_testsets/MLR_CUHK03/')
    os.system('ln -s /mnt/data/datasets/CUHK03/MLR_CUHK03/bounding_box_test/  results/swinir_classical_sr_'+ scale +'_testsets/MLR_CUHK03/')
    os.system(sr_train)
