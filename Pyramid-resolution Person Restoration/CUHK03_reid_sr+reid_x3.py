...
models_path = '/home/gpu/code/SwinIR-main/model_zoo/CUHK03/x3' #model path
...
sr_task = 'python main_nogt_swinir.py --task classical_sr --scale 3 --training_patch_size 64 --window_size 8 --model_path '
set = 'x3'
...
for i in  range(len(dir_list)):
    ...
    reid_log = ' data.save_dir /mnt/data/code/reidlog/CUHK03/x3/osnet_x1_0_test_x3_CUHK03_softmax_cosinelr'

    #超分
    os.system(sr_query)
    os.system('cp -r /mnt/data/datasets/CUHK03/bounding_box_train/  results/swinir_classical_sr_x3_testsets/MLR_CUHK03/')
    os.system('ln -s /mnt/data/datasets/CUHK03/MLR_CUHK03/bounding_box_test/  results/swinir_classical_sr_x3_testsets/MLR_CUHK03/')
    os.system(sr_train)


    #更改文件夹名称
    dirdatasets = 'results/swinir_classical_sr_' + set + '_' + dir_list[i].split('.')[0]
    rename_dirdatasets = 'mv results/swinir_classical_sr_x3_testsets ' + dirdatasets
