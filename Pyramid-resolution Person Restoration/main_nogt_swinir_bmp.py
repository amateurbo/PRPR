...
def main():
    ...
    parser.add_argument('--folder_lq', type=str, default='/mnt/data/mlr_datasets/MLR_Market1501/market1501/query',
                        help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default='/mnt/data/code/asr/RetinexNet-master/test_results',
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(folder, '*')))):
        ...
        save = f'{save_dir}/{imgname}.bmp'
        cv2.imwrite(f'{save_dir}/{imgname}.bmp', output)
...
def get_image_pair(args, path):
    ...
    # 006 JPEG compression artifact reduction (load gt image and generate lq image on-the-fly)
        ...
        result, encimg = cv2.imencode('.bmp', img_gt, [int(cv2.IMWRITE_JPEG_QUALITY), args.jpeg])
