...
def main():
    ...
    parser.add_argument('--noise', type=int, default=50, help='noise level: 15, 25, 50')
    parser.add_argument('--jpeg', type=int, default=40, help='scale factor: 10, 20, 30, 40')
    parser.add_argument('--window_size', type=int, default=8)
    parser.add_argument('--training_patch_size', type=int, default=64, help='patch size used in training SwinIR. '
                                       'Just used to differentiate two different settings in Table 2 of the paper. '
                                       'Images are NOT tested patch by patch.')
    parser.add_argument('--large_model', default=True, action='store_true', help='use large model, only provided for real image sr')
    parser.add_argument('--model_path', type=str,
                        default='./model_zoo/swinir/001_classicalSR_DF2K_s64w8_SwinIR-M_x4.pth')
    parser.add_argument('--folder_lq', type=str, default='/home/gpu/Pictures/sr',
                        help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default='/home/gpu/Pictures/sr',
                        help='input ground-truth test image folder')
    # parser.add_argument('--folder_lq', type=str, default='/mnt/data/code/SwinIR-main/results/swinir_classical_sr_x4_/home/gpu/Pictures/sr_duke',
    #                     help='input low-quality test image folder')
    # parser.add_argument('--folder_gt', type=str, default='/mnt/data/code/SwinIR-main/results/swinir_classical_sr_x4_/home/gpu/Pictures/sr_duke',
    #                     help='input ground-truth test image folder')
    args = parser.parse_args()
...
def setup(args):
    ...
    # 004 grayscale image denoising/ 005 color image denoising
        ...
        save_dir = f'results/swinir_{args.task}_noise{args.noise}_{args.folder_gt}'
