...
if __name__ == '__main__':
    ...
    #     savepath='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC_CUBIC',
    ...
    reid(
        datapath='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC_CUBIC',
        pypath='/mnt/data/code/deep-person-reid-master/scripts/mlr_dukemtmc_new.py',
        savedir='/mnt/data/code/reidlog/mlr_DukeMTMC_CUBIC/',
