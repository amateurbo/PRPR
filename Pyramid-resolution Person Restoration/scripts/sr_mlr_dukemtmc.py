...
if __name__ == '__main__':
    ...
    #     savepath='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_dukemtmc_l1',
    #     modelpath='/mnt/data/code/superresolution/dukemtmc_l1/swinir_sr_dukemtmc_x4/models/5000_G.pth',
    #     subdirs=['query', 'bounding_box_test', 'bounding_box_train'],
    #     format='.jpg'
    # )

    # reid(
    #     datapath='/mnt/data/datasets/MTA_reid/MTA_reid_HAN_2',
    #     pypath='/mnt/data/code/deep-person-reid-master/scripts/MTA_reid_new.py',
    #     savedir='/mnt/data/code/reidlog/MTA_reid_HAN_2/',
    #     config_path='/mnt/data/code/deep-person-reid-master/configs/MTA_reid.yaml',
    # )
    ...
    # reid(
    #     datapath='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_dukemtmc_l1',
    #     pypath='/mnt/data/code/deep-person-reid-master/scripts/mlr_dukemtmc_new.py',
    #     savedir='/mnt/data/code/reidlog/mlr_dukemtmc_l1/',
