...
models_path = '/home/gpu/code/SwinIR-main/model_zoo/market_x4/' #model path
...
sr_task = 'python main_nogt_swinir_market1501.py --task classical_sr --scale 4 --training_patch_size 64 --window_size 8 --model_path '
set = 'x4'
...
for i in  range(len(dir_list)):
    ...
    reid_log = ' data.save_dir /mnt/data/code/reidlog/market1501x4/osnet_x1_0_test_x4_market1501_softmax_cosinelr'
    ...
    #将其他数据复制过来
    os.system('ln -s /mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/market1501/bounding_box_test/ results/swinir_classical_sr_x4_testsets/mlr_market1501_split0/')
    ...
    os.system('mv results/swinir_classical_sr_x4_testsets/mlr_market1501_split0/ results/swinir_classical_sr_x4_testsets/mlr_market1501/')
    dirdatasets = 'results/swinir_classical_sr_x4_' + set + '_' + dir_list[i].split('.')[0]
