...
writer = SummaryWriter('/mnt/data/code/SwinIR-main/srlog_mlr_cam_s16w8_x2/')
...
for s in data:
    ...
    writer.add_scalars('SR/PNSR/iter',
                       {'query_PSNR': s[1], 'query_PSNR_Y': s[3], 'train_PSNR': s[5], 'train_PSNR_Y': s[7]}, s[0])
    writer.add_scalars('SR/SSIM/iter',
                       {'query_SSIM_RGB': s[2], 'query_SSIM_Y': s[4], 'train_SSIM_RGB': s[6], 'train_SSIM_Y': s[8]}, s[0])
