...
models_path = '/home/gpu/code/SwinIR-main/model_zoo/unresize_mlr_rcam_market_x2/' #model path
query = ' --folder_lq testsets/mlr_cam_market1501/query/ --folder_gt testsets/mlr_cam_market1501/hrquery/' #query 低分图像路径 高分图像路径
train = ' --folder_lq testsets/mlr_cam_market1501/bounding_box_train/ --folder_gt testsets/mlr_cam_market1501/hrtrain/' #train 低分图像路径 高分图像路径
sr_task = 'python main_test_swinir.py --task classical_sr --scale 2 --training_patch_size 64 --window_size 8 --model_path '
set = 'mlr_cam_s64w8_x2'
...
for i in  range(len(dir_list)):
    ...
    reid_log = ' data.save_dir log_unresize_mlr_cam_s64w8_x2/osnet_x1_0_test_x2_market1501_softmax_cosinelr'
    ...
    #将其他数据复制过来
    os.system('ln -s /mnt/data/market/market1501/mlr_market1501/bounding_box_test/ results/swinir_classical_sr_x2_testsets/mlr_cam_market1501/')
    os.system('cp -r /mnt/data/market/market1501/mlr_market1501/bounding_box_train results/swinir_classical_sr_x2_testsets/mlr_cam_market1501/bounding_box_train')
    ...
    os.system('mv results/swinir_classical_sr_x2_testsets/mlr_cam_market1501/ results/swinir_classical_sr_x2_testsets/market1501/')
