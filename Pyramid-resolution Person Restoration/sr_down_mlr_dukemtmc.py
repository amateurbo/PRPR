...
if __name__ == '__main__':
    ...
    #     savepath='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down',
    ...
    reid(
        datapath='/mnt/data/mlr_datasets/dukemtmc-reid/mlr_DukeMTMC-reID_new_sr_down',
        pypath='/mnt/data/code/deep-person-reid-master/scripts/mlr_dukemtmc_new.py',
        savedir='/mnt/data/code/reidlog/mlr_dukemtmc_new/',
