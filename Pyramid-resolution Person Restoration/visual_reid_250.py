...
path = '/mnt/data/code/reidlog/market1501x4'
...
for i in range(len(dir_list)):
    ...
    writer = SummaryWriter('/mnt/data/code/reidlog/market1501x4/visual_reid/'+dir_list[i])
    ...
    writer.add_scalar('ReID/mAP/epoch', data[250][1], data[250][0])
    writer.add_scalar('ReID/Rank1/epoch', data[250][2], data[250][0])
    writer.add_scalar('ReID/Rank5/epoch', data[250][3], data[250][0])
    writer.add_scalar('ReID/Rank10/epoch', data[250][4], data[250][0])
    writer.add_scalar('ReID/Rank20/epoch', data[250][5], data[250][0])
