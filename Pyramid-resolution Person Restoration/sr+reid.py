...
query = ' --folder_lq testsets/mlr_market1501_x2/query/ --folder_gt market1501/query/' #query 低分图像路径 高分图像路径
train = ' --folder_lq testsets/mlr_market1501_x2/bounding_box_train/ --folder_gt market1501/bounding_box_train/' #train 低分图像路径 高分图像路径
...
for i in  range(len(dir_list)):
    ...
    reid_log = ' data.save_dir log_s64w8_x2/osnet_x1_0_test_x2_market1501_softmax_cosinelr'
    ...
    #更改文件夹名称
    os.system('ln -s /mnt/data/mlr_datasets/market1501/bounding_box_test/ results/swinir_classical_sr_x2_testsets/mlr_market1501_x2/')
    os.system('mv results/swinir_classical_sr_x2_testsets/mlr_market1501_x2/ results/swinir_classical_sr_x2_testsets/market1501/')
