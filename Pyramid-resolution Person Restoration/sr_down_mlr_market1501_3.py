import sr_down_mlr_dukemtmc_3 as sd
...
if __name__ == '__main__':
    ...
    sd.sr_down(
        ...
        savepath='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down_3',
    ...
    # pypath: path of reid.py    kuak
    # savedir: log path
    # config_path: reid config path
    sd.reid(
        datapath='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down_3',
        pypath='/mnt/data/code/deep-person-reid-master/scripts/mlr_market1501_new.py',
        savedir='/mnt/data/code/reidlog/mlr_market1501_new_3/',
