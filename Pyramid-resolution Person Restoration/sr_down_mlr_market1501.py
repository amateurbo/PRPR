...
if __name__ == '__main__':
    ...
    #     savepath='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down',
    ...
    sd.reid(
        datapath='/mnt/data/code/Generate_Mlrdataset/MLR_Market1501/split0/mlr_market1501_new_sr_down',
        pypath='/mnt/data/code/deep-person-reid-master/scripts/mlr_market1501_new.py',
        savedir='/mnt/data/code/reidlog/mlr_market1501_new/',
