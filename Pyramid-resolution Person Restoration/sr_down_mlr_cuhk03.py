...
if __name__ == '__main__':
    ...
    sd.sr_down(
        ...
        savepath='/mnt/data/datasets/CUHK03/mlr_cuhk03_new_sr_down',
    ...
    sd.reid(
        datapath='/mnt/data/datasets/CUHK03/mlr_cuhk03_new_sr_down',
        pypath='/mnt/data/code/deep-person-reid-master/scripts/mlr_cuhk03_new.py',
        savedir='/mnt/data/code/reidlog/mlr_cuhk03_new/',
